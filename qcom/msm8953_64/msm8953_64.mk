...
PRODUCT_VER    := 11.1.6.02
else
PRODUCT_VER    := 31.1.6.02
endif
PRODUCT_EXT_APK := lm
else
ifeq ($(PRODUCT_RB_OTA), enabled)
PRODUCT_VER    := 10.1.6.02
else
PRODUCT_VER    := 30.1.6.02
endif
PRODUCT_EXT_APK :=
endif
PRODUCT_VARIANT := smartcam
...
ifeq ($(TARGET_BUILD_VARIANT),user)
ifeq ($(PRODUCT_RB_OTA), enabled)
PRODUCT_VER    := 01.1.6.02
else
PRODUCT_VER    := 21.1.6.02
endif
PRODUCT_GMS_COMMON := true
DISPLAY_BUILD_NUMBER := true
else
ifeq ($(PRODUCT_RB_OTA), enabled)
PRODUCT_VER    := 00.1.6.02
else
PRODUCT_VER    := 20.1.6.02
endif
PRODUCT_GMS_COMMON ?= false
endif
endif
