...
PRODUCT_COPY_FILES := \
    device/qcom/apq8098_latv/permissions/tv_core_hardware.xml:system/etc/permissions/tv_core_hardware.xml

DEVICE_PACKAGE_OVERLAYS := \
    device/qcom/apq8098_latv/overlay
...
# LiveTv source is currently not part of the code base
ifeq (0,true)
ifneq ($(USE_OEM_TV_APP),true)
    ...
    PRODUCT_COPY_FILES += \
        device/qcom/apq8098_latv/permissions/com.google.android.tv.installed.xml:system/etc/permissions/com.google.android.tv.installed.xml
endif
endif
...
PRODUCT_COPY_FILES += \
    device/qcom/apq8098_latv/tutorial-library-google.zip:system/media/tutorial-library-google.zip
